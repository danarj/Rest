...
public class RIVExtendedSoapSerializationEnvelope extends SoapSerializationEnvelope {
    static HashMap< java.lang.String,java.lang.Class> classNames = new HashMap< java.lang.String, java.lang.Class>();
    static {
        classNames.put("http://schemas.datacontract.org/2004/07/ResturantService.Request^^RequestHeader",RIVRequestHeader.class);
        classNames.put("http://schemas.datacontract.org/2004/07/ResturantService.Result^^ResultHeader",RIVResultHeader.class);
        classNames.put("http://tempuri.org/^^AuthenticateUserResult",RIVAuthenticateUserResult.class);
    }   

    protected static final int QNAME_NAMESPACE = 0;
    private static final String TYPE_LABEL = "type";

    public RIVExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public RIVExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new RIVMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            ...
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=RIVHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    public java.lang.Object get(java.lang.Object soap,java.lang.Class cl)
    {
        ...
        try
        {
            ...
            {
                Constructor ctor = cl.getConstructor(java.lang.Object.class,RIVExtendedSoapSerializationEnvelope.class);
